...
export function Mobile() {
  return (
    <section className=" xl:h-screen lg:h-screen md:h-[800px] sm:h-[700px] h-[600px]  relative  overflow-hidden bg-[#F1F1F1]">
          <img
          src={curva1}
      ...
      <div className="md:flex lg:w-full mx-auto text-center md:flex-row  flex flex-col  md:text-left justify-center w-48 gap-x-2 items-center z-50">
        ...
        <div className="w-full h-full flex justify-center absolute 2xl:-top-32  xl:-top-28 lg:top-0 md:top-28 sm:top-28 top-28 pb-10  flex-col items-center mt-20 ">
          <Card />
        </div>
